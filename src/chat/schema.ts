...
export const messageSchema = z
  .object({
    ...
    /** Редактор / видео: center — текст по центру, bubble — пузырь, scene — описание без текста на экране */
    display: z.enum(["center", "bubble", "scene"]).optional(),
    ...
    .object({
      ...
      opening: z
        .object({
          ...
          animation: z
            .enum(["video", "video-parallax", "video-kenburns", "none", "kenburns", "parallax", "depthParallax"])
            .optional()
            .default("video-kenburns"),
          storySfx: z.array(storySfxCueSchema).max(4).optional(),
        })
        .optional(),
      ...
      colorFilter: z
        .enum(["none", "warm", "cold", "cinematic", "vintage", "noir", "vivid"])
        .optional()
        .default("none"),
